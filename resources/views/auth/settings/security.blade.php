<x-app-layout :title="__('Account instellingen')">
    <div class="container">
        <div class="page-header">
            ...
            <div class="page-subtitle">{{ __('Beveiliging instellingen') }}</div>
        </div>
    </div>
                ...
                <x-form method="PATCH" class="card border-0 shadow-sm" :action="route('account.settings.security')">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" name="currentPassword" class="form-control @error('currentPassword', 'updatePassword') is-invalid @enderror" id="currentPassword" placeholder="{{ __('huidig wachtwoord') }}">
                                <x-error class="invalid-feedback" field="currentPassword" bag="updatePassword"/>
                            </div>
                        </div>
